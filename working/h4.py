...
las_fock_ci1 = cilas2f(las.ci[0], las.ncas_sub, las.nelecas_sub)
las_fock_ci2 = cilas2f(las.ci[1], las.ncas_sub, las.nelecas_sub)
psi1 =  getattr (fci, 'psi', fci.build_psi (las_fock_ci1, ncas, las.ncas_sub, nelec)) # not sure about this
psi2 =  getattr (fci, 'psi', fci.build_psi (las_fock_ci2, ncas, las.ncas_sub, nelec)) # not sure about this
psis = [psi1, psi2]
