#!/usr/bin/env python3
"""
Stilbene-120 - VQE MAX_CYCLES 10 vs 50 COMPARISON TEST
...
def main():
    print('='*80)
    print('STILBENE-120 - VQE MAX_CYCLES 10 vs 50 COMPARISON')
    ...
    try:
        comparison_10 = Stilbene120EnergyComparison(
            basis='sto-3g',
    ...
    try:
        comparison_50 = Stilbene120EnergyComparison(
            basis='sto-3g',
            gradient_threshold=0.01,
            vqe_max_cycles=50,
            verbose=1
    ...
    print('\n' + '='*80)
    print('STILBENE-120 COMPARISON COMPLETE')
    print('='*80)
