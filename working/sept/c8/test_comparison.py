#!/usr/bin/env python3
"""
C8 - VQE MAX_CYCLES 10 vs 50 COMPARISON TEST
...
from c8_energy_comparison import C8EnergyComparison
import time

def main():
    print('='*80)
    print('C8 - VQE MAX_CYCLES 10 vs 50 COMPARISON')
    ...
    try:
        comparison_10 = C8EnergyComparison(
            basis='sto-3g',
    ...
    try:
        comparison_50 = C8EnergyComparison(
            basis='sto-3g',
            gradient_threshold=0.01,
            vqe_max_cycles=50,
            verbose=1
