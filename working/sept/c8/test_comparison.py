#!/usr/bin/env python3
"""
C8 - 4-Parameter Combination Test
...
def main():
    print('='*80)
    print('C8 - 4-PARAMETER COMBINATION COMPARISON')
    ...
    print('\n' + '='*100)
    print('SUMMARY OF ALL 4 TEST CASES - C8')
    print('='*100)
    ...
    print('\n' + '='*80)
    print('C8 4-PARAMETER COMPARISON COMPLETE')
    print('='*80)
