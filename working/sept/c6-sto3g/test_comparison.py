#!/usr/bin/env python3
"""
C6 (STO-3G) - VQE MAX_CYCLES 10 vs 50 COMPARISON TEST
...
def main():
    print('='*80)
    print('C6 (STO-3G) - VQE MAX_CYCLES 10 vs 50 COMPARISON')
    ...
    try:
        comparison_10 = C6EnergyComparison(
            basis='sto-3g',
    ...
    try:
        comparison_50 = C6EnergyComparison(
            basis='sto-3g',
            gradient_threshold=0.01,
            vqe_max_cycles=50,
            verbose=1
    ...
    print('\n' + '='*80)
    print('C6 (STO-3G) COMPARISON COMPLETE')
    print('='*80)
