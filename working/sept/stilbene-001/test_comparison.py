#!/usr/bin/env python3
"""
Stilbene-001 - VQE MAX_CYCLES 10 vs 50 COMPARISON TEST
...
# Import using filename with hyphen
exec(open('./stilbene-001_energy_comparison.py').read())
import time

def main():
    print('='*80)
    print('STILBENE-001 - VQE MAX_CYCLES 10 vs 50 COMPARISON')
    ...
    try:
        comparison_10 = Stilbene001EnergyComparison(
            basis='sto-3g',
    ...
    try:
        comparison_50 = Stilbene001EnergyComparison(
            basis='sto-3g',
            gradient_threshold=0.01,
            vqe_max_cycles=50,
            verbose=1
    ...
    print('\n' + '='*80)
    print('STILBENE-001 COMPARISON COMPLETE')
    print('='*80)
