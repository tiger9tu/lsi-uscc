#!/usr/bin/env python3
"""
C10 - VQE MAX_CYCLES 10 vs 50 COMPARISON TEST
...
def main():
    print('='*80)
    print('C10 - VQE MAX_CYCLES 10 vs 50 COMPARISON')
    ...
    try:
        comparison_10 = C10EnergyComparison(
            basis='sto-3g',
    ...
    try:
        comparison_50 = C10EnergyComparison(
            basis='sto-3g',
            gradient_threshold=0.01,
            vqe_max_cycles=50,
            verbose=1
