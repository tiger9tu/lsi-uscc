...
# The following is where I previously did, I tired to perform VQE on each LASSIS state
# However, it seems that all the states collapse to the same state so this idea does not work
