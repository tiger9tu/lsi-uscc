...
echo "host=$(hostname) job=${SLURM_JOB_ID} script=tasks/fe3/lassis_from_saved.py cpus=${SLURM_CPUS_PER_TASK}"
python -u tasks/fe3/lassis_from_saved.py --max-memory 120000
