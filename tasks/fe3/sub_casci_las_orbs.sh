...
echo "host=$(hostname) job=${SLURM_JOB_ID} script=tasks/fe3/casci_las_orbs.py cpus=${SLURM_CPUS_PER_TASK}"
python -u tasks/fe3/casci_las_orbs.py --max-memory 120000
