...
echo "host=$(hostname) job=${SLURM_JOB_ID} script=tasks/fe3/las_luscc.py cpus=${SLURM_CPUS_PER_TASK}"
python -u tasks/fe3/las_luscc.py --frac 0.01 --max-memory 120000
