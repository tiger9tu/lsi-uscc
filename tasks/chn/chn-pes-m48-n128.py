...
Fixed hyperparameters: m = 48 (dominant LAS components), n = 128 (excitations).
...
Checkpointing
-------------
ckpt/pes_m48_n128/dr{ix:02d}_grad.npz    saved after gradient step (before lsi-luscc)
ckpt/pes_m48_n128/dr{ix:02d}_result.npz  saved after lsi-luscc (includes all 5 energies)
...
# ── Checkpoint helpers ─────────────────────────────────────────────────────
CKPT_DIR = Path(__file__).parent / "ckpt" / "pes_m48_n128"
...
# ── Parameters ────────────────────────────────────────────────────────────
M = 48      # number of dominant LAS components
N = 128     # number of excitations
