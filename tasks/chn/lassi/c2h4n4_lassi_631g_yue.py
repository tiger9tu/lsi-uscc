...
# Source - https://stackoverflow.com/a/56711486
# Posted by Kais Tounsi
...
a_idxs_selected, i_idxs_selected, g = util.get_sorted_excitations (a_idxs, i_idxs, my_gs, fraction = 0.06, verbose=3)
