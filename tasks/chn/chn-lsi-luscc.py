...
# ── 1. System parameters ───────────────────────────────────────────────────
FRAC = 0.02  # fraction of excitations to include
SI_THRESHOLD = 0.1   # |SI coefficient| cutoff for significant LAS components
...
mol.output = 'c2h4n4_631g_lsi.log'
mol.verbose = 3
mol.spin = 8
...
# ── 6. LSI-LUSCC ────────────────────────────────────────────────────────────
# Pass the LASSI object (lsi) so that excitations are applied to all
# significant LAS components |las_j> of the LSI ground state.
t0 = time()
