...
Fixed hyperparameters: m = 48 (dominant LAS components), n = 66 (excitations).
...
Checkpointing
-------------
ckpt/pes/dr{ix:02d}_grad.npz    saved after gradient step (before lsi-luscc)
ckpt/pes/dr{ix:02d}_result.npz  saved after lsi-luscc (includes all 5 energies)
...
# ── Checkpoint helpers ─────────────────────────────────────────────────────
CKPT_DIR = Path(__file__).parent / "ckpt" / "pes"
